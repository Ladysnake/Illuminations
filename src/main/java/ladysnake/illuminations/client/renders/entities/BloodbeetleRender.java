...
public class BloodbeetleRender<T extends Entity> extends EntityRenderer<T> {
    public BloodbeetleRender(EntityRenderDispatcher renderManager) {
        super(renderManager);
        this.field_4672 = 0;
    }
    ...
    public void render(Entity entity, double x, double y, double z, float entityYaw, float tickDelta) {
        if (!this.renderOutlines) {
            ...
            if (entity instanceof FireflyEntity) {
                ...
                GlStateManager.color4f(1F, color/2, color/2, ((FireflyEntity) entity).getAlpha());
            }
