...
public class CrownEntityModel<T extends LivingEntity> extends PlayerEntityModel<T> {
	...
	public CrownEntityModel() {
		...
		crown.setTextureOffset(0, 0).addCuboid(-4.0F, -17.0F, -4.0F, 8.0F, 8.0F, 8.0F, -0.5F, true);

		west_r1 = new ModelPart(this);
		west_r1.setPivot(0.0F, -11.0F, 0.0F);
		...
		north_r1.setPivot(0.0F, -11.0F, 0.0F);
		...
		east_r1.setPivot(0.0F, -11.0F, 0.0F);
		...
		south_r1.setPivot(0.0F, -11.0F, 0.0F);
