...
public class DefaultConfig {
    ...
    public static final ImmutableMap<BiomeCategory, BiomeSettings> BIOME_SETTINGS = ImmutableMap.<BiomeCategory, BiomeSettings>builder()
            ...
            .put(WARM_OCEAN, new BiomeSettings(FireflySpawnRate.DISABLE, 0xBFFF00, GlowwormSpawnRate.DISABLE, PlanktonSpawnRate.DISABLE))
            .put(THE_NETHER, new BiomeSettings(FireflySpawnRate.DISABLE, 0xFF8000, GlowwormSpawnRate.DISABLE, PlanktonSpawnRate.DISABLE))
            .put(THE_END, new BiomeSettings(FireflySpawnRate.DISABLE, 0x8000FF, GlowwormSpawnRate.DISABLE, PlanktonSpawnRate.DISABLE))
