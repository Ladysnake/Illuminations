...
public abstract class ThrownLightOrbEntity extends LightOrbEntity implements Projectile, Living {
    private int blockX;
    private int blockY;
    private int blockZ;
    ...
    protected ThrownLightOrbEntity(EntityType<?> entityType_1, World world_1) {
    ...
    protected ThrownLightOrbEntity(EntityType<?> entityType_1, double double_1, double double_2, double double_3, World world_1) {
        this(entityType_1, world_1);
        this.setPosition(double_1, double_2, double_3);
    }

    protected ThrownLightOrbEntity(EntityType<?> entityType_1, LivingEntity livingEntity_1, World world_1) {
